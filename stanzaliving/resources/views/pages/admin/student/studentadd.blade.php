...
<div class="col-md-2">
  <div class="form-group" style="margin-top: 20px;">
    <a href="{{url('admin/student/contactvalidate')}}" class="btn btn-back " style="margin-top: 70px;float: right;">Back</a>
  </div>
</div>
</div>
          ...
          <div class="box-body">
               <div class="col-xs-4">
                 <div class="form-group">
                  ...
                  {!!     Form::hidden('s_contact', $guardian[0]->p_contact ,  ['class' => 'form-control', 'placeholder' => 'Parent\'s Name']) !!}

    {!!     Form::text('s_contact', $guardian[0]->p_contact,  ['class' => 'form-control', 'placeholder' => 'Contact Number', 'disabled' => 'disable']) !!}
        ...
        <!-- /.box-body -->
          <div class="box-footer">
              <div class="col-md-12">
                ...
                <a href="{{url('admin/student/contactvalidate')}}"  class="btn btn-back " style="margin-bottom:65px;">Back</a>
